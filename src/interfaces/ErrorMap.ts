...
export interface ErrorMap {
  ...
  QUERY: {
    ...
    PIVOT_MISSING_COLUMN: string
    PIVOT_MISSING_VALUES: string
    PIVOT_MISSING_AGGREGATE: string
    UNPIVOT_MISSING_COLUMNS: string
    UNPIVOT_MISSING_VALUE_COLUMN: string
    UNPIVOT_MISSING_NAME_COLUMN: string
    ORDINALITY_MISSING_VALUE_COLUMN: string
    ORDINALITY_MISSING_ORDINALITY_COLUMN: string
